...
MATERIAL_ADMIN_SITE = {
    ...
    'PROFILE_PICTURE': 'admin/logo_admin.png',
    # Admin site profile picture (path to static should be specified)
    'PROFILE_BG': 'admin/fon.png',  # Admin site profile background (path to static should be specified)
    # 'LOGIN_LOGO': 'admin/logo_admin.png',  # Admin site logo on login page (path to static should be specified)
    'LOGOUT_BG': 'admin/fon5.png',
...
AUTH_USER_MODEL = 'crm_user.CrmUser'
