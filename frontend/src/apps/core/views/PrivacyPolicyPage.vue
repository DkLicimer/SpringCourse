<template>
  <div class="flex-1-1 position-relative bg-grey-lighten-4 ">
    <div class="align-items-center h-100">
      <v-container class="pb-10">
        <div class="d-flex">
          <h1 class="mb-3 me-auto">Политика конфиденциальности</h1>
        </div>
            ...
            <div class="col">
              ...
              <div class="descr">
                ...
                данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value"
                                              data-scroll-to="#owner-name-field">{{ core.businessman }}</span>
                (далее&nbsp;— Оператор).
              </div>
              <div class="ol">
                <div class="li">
                ...
                <div class="li">
                  ...
                  class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">{{ core.domen }}</span>.
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="ol">
                ...
                <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                  ...
                  Пользователю веб-сайта <span class="link mark owner-site-url-field"
                                               data-scroll-to="#owner-site-url-field">{{ core.domen }}</span>.
                </div>
                <div class="li">
                  ...
                  <table class="purpose-table">
                    ...
                    <tr>
                      ...
                      <td class="legal-field">
                        <ul>
                          <li><span class="mark link">согласие субъектов на обработку их персональных данных</span></li>
                        </ul>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="types-field">
                        <ul>
                          ...
                          <li><span
                            class="mark link">Отправка информационных писем на&nbsp;адрес электронной почты</span></li>
                        </ul>
                      </td>
                    </tr>
                    </tbody>
            ...
            <div class="col">
              ...
              <div class="ol">
                ...
                <div class="li">
                  ...
                  class="link mark owner-email-field" data-scroll-to="#owner-email-field">{{ core.email }}</span>
              ...
              <div class="ol">
                <div class="li">
                  ...
                  к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field"
                                                                          data-scroll-to="#owner-email-field">{{ core.email }}</span>.
                </div>
                <div class="li">
                ...
                <div class="li">
                  ...
                  в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value"
                                                            ...
                                                            data-scroll-to="#owner-privacy-url-field">{{ core.domen }}/privacy-policy</span>.
                </div>
              </div>
            </div>
          </div>
