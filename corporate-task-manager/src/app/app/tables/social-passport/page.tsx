// src/app/app/tables/social-passport/page.tsx
...
import { SocialPassportClient } from "./SocialPassportClient";

export default async function SocialPassportPage() {
