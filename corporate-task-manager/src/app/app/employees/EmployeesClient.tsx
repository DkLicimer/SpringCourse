...
export function EmployeesClient({ initialUsers, currentUserId }: EmployeesClientProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 💻 ДЕСКТОПНАЯ ТАБЛИЦА С ЗАКРЕПЛЕННОЙ КОЛОНКОЙ ФИО И КОМПАКТНЫМИ ЗАГОЛОВКАМИ */}
            ...
            {filteredUsers.map((user) => {
              ...
              return (
                <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                  {/* ⚡ ЗАКРЕПЛЕННАЯ СЛЕВА КОЛОНКА ФИО */}
                ...
                <div>
                  ...
                  {editingUser && (
                    <p className="text-[10px] text-slate-400 mt-1 leading-tight">
                      * В целях безопасности существующие пароли зашифрованы в базе данных и не отображаются. Глазок активен для проверки вводимого нового пароля.
                    </p>
                  )}
                </div>
              </div>
