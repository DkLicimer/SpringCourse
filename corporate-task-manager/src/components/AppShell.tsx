  ...
  return (
    <div className="flex h-screen bg-slate-100 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        {/* Шапка (Header) */}
        <header className="flex items-center justify-between h-16 bg-white border-b border-slate-200 px-4 md:px-6 z-10 print:hidden shrink-0">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <GeneralChatWidget currentUserId={sessionUser.id} isAdmin={isAdmin} />
            <NotificationBell />

            <div className="flex items-center gap-2 md:gap-3 border-l border-slate-200 pl-2 md:pl-3">
        ...
        {/* Контент страницы без конфликтующих transform-стилей */}
