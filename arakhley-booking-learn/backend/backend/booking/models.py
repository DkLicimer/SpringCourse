...
class GalleryPhoto(models.Model):
    """Модель для динамической галереи на главной странице"""
    image = models.ImageField(upload_to=gallery_photo_upload_path, verbose_name="Фотография")
    caption = models.CharField(max_length=255, blank=True, null=True, verbose_name="Описание (подпись)")
    ...
    def __str__(self):
        return self.caption or f"Фотография №{self.id}"