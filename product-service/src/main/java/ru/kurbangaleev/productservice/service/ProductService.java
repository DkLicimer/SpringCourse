...
public class ProductService {
    ...
    public Product getProductById(Long id) {
        return productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Продукт с таким индефикатором не был найден:" + id));
    }
    ...
    public void updateStock(Long id, int quantity) {
        ...
        if (newQuantity < 0) {
            throw new IllegalArgumentException("Недостаточно товара на складе для товара с идентификатором:" + quantity);
        }
